 ...
 * server can't do: refuse to mount on /admin, and re-fire PageView when the
 * App Router navigates without a document load (the snippet only ever fires
 * the first one).
 *
...
export function MetaPixel() {
  ...
  // The inline snippet fires the first PageView itself, so remember the path we
  // mounted on and report only the navigations after it.
