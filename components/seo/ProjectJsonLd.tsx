    ...
    "@graph": [
      {
        ...
        description:
          "A 100-acre residential township in Manpada, Dombivli, Mumbai offering premium 1, 2, 3 & 4 BHK homes, villas, bungalows and duplexes from ₹54 Lakhs++, with metro connectivity, clubhouse, temple and modern amenities — ideal for NRIs and Mumbai homebuyers.",
        address: {
          "@type": "PostalAddress",
