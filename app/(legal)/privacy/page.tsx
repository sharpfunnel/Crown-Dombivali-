...
export const metadata: Metadata = {
  ...
  description:
    "How enquiry details submitted for Crown Dombivli Manpada are collected, used and protected.",
};
    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            "By submitting an enquiry form on this page, you authorise us to contact you by phone, SMS, email and WhatsApp regarding Crown Dombivli Manpada, including on numbers registered with DND.",
