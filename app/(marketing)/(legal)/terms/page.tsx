...
export const metadata: Metadata = {
  ...
  description:
    "Terms governing use of the Crown Dombivli Manpada website and the information published on it.",
};
      ...
      sections={[
        {
          ...
          body: [
            "By accessing this website you agree to these terms. The content published here is for general information about Crown Dombivli Manpada and does not constitute an offer, invitation or contract of any kind.",
          ],
        },
        {
